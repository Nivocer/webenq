...
/** @see WebEnq4_Form_Element_MlText */
require_once 'WebEnq4/Form/Element/MlText.php';

/**
 * @package    WebEnq4_Tests
 */
class WebEnq4_Form_Element_MlTextTest extends PHPUnit_Framework_TestCase
{
    public function testNoInputForRequiredElementShouldFail()
    {
        $element = new WebEnq4_Form_Element_MlText('item');
        $element->setRequired();
