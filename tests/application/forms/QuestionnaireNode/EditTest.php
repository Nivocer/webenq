 ...
 * @package    Webenq_Tests
 */
class Webenq_Test_Form_QuestionnaireNode_EditTest extends Webenq_Test_Form_QuestionnaireNode_AddTest
{
    public function testOneLanguageIsRequired()
    {
        $question = new Webenq_Model_Question();

        $this->_form = new Webenq_Form_QuestionnaireNode_Edit($question);
