...
class Webenq_Test_Form_Category_Edit extends Webenq_Test_Case_Form
{
    ...
    */
    ...
    public function testFormHasCorrectDefaults()
    {
        ...
        $this->assertEquals(1, $form->getValue('active'));
        $this->assertEquals("form has correct defaults: nl", $form->getValue('nl'));
        $this->assertEquals("form has correct defaults: en", $form->getValue('en'));
        $this->assertNotEquals("wrong category", $form->getValue('en'));
        $c->delete();
    }
}
