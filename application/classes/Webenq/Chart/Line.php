 ...
 */
abstract class Webenq_Model_Output_Chart_Line extends Webenq_Model_Output_Chart
{
    public static function factory($type=null)
    {
        ...
        if (isset($type)) {
            if (in_array($type, $chartTypes)) {
                $class = "Webenq_Model_Output_Chart_Line_" . $type;
                return new $class();
            } else {
                throw new Exception("Wrong type given");
            }
        } else {
            return new Webenq_Model_Output_Chart_Line_Normal();
        }
    }
