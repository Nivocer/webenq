 ...
 */
class Webenq_Model_Question_Closed_Scale_Four extends Webenq_Model_Question_Closed_Scale
{
    /**
     * Child classes
     *
    ...
    static public function isType(Webenq_Model_Question $question)
    {
        ...
        if ($question->countUniqueExcludingNullValues() > 4) {
            return false;
        }
        ...
        if ($group->AnswerPossibility[0]->value != 4) {
            return false;
        }
